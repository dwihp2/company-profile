...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_services_category" AS ENUM('development', 'mobile', 'strategy', 'marketing', 'security', 'cloud', 'consulting', 'design');
  CREATE TYPE "public"."enum_project_categories_color" AS ENUM('blue', 'green', 'purple', 'red', 'orange', 'pink', 'indigo', 'gray');
  ...
  CREATE TABLE "project_categories" (
  	...
  	"slug" varchar NOT NULL,
  	"description" varchar,
  	"color" "enum_project_categories_color",
  	"order" numeric DEFAULT 0,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_project_categories_color";`)
}
